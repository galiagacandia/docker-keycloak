    ...
    <div class="contenido-pagina shadow-3">
        ...
        <form action="${url.totpUrl}" method="post">
            ...
            <div class="form-outline mb-4">
                <input type="text" class="form-control form-control-lg" id="totp" name="totp" autocomplete="off" autofocus>
                <input type="hidden" id="totpSecret" name="totpSecret" value="${totp.totpSecret}"/>
                <label for="totp" class="form-label">${msg("authenticatorCode")} <span class="required">*</span></label>
            </div>

            <div class="form-outline mb-4" ${messagesPerField.printIfExists('userLabel',properties.kcFormGroupErrorClass!)}">
                <input type="text" class="form-control form-control-lg" id="userLabel" name="userLabel" autocomplete="off">
                <label for="userLabel" class="form-label">${msg("totpDeviceName")} <#if totp.otpCredentials?size gte 1><span class="required">*</span></#if></label>
            </div>
